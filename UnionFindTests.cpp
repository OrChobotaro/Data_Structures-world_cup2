...
bool test_union_player_to_empty_team() {
    ...
    bool resRankTreeBefore = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 0)));
    ...
    bool resRankTreeAfter = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 4)));

    return res1 == true && res2 == false && res3 == false &&
           res4 == true && res5 == true && res6 == true &&
           res7 == true && res8 == true && res9 == true &&
           resRankTreeBefore == true && resRankTreeAfter == true;
...
bool test_union_player_to_team() {
    ...
    bool resRank1 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 9)));
    ...
    bool resRank2 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 9)));
    ...
    bool resRank3 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 28)));
    bool resRank4 = (wc.m_rankAbilityTree->find(AbilityDataTeam(12, 7)));
    ...
    return res1 == true  &&  res2 == true  &&  res3 == true &&
           ...
           res21 == true  &&
           resRank1  &&  resRank2  &&  resRank3  && resRank4;
}
...
bool test_union_buyer_team_is_bigger() {
    ...
    bool resRank1 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 13)));
    bool resRank2 = (wc.m_rankAbilityTree->find(AbilityDataTeam(12, 2)));
    ...
    bool resRank3 = (wc.m_rankAbilityTree->find(AbilityDataTeam(13, 56)));
    bool resRank4 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 13)));
...
bool test_union_bought_team_is_bigger() {
    ...
    bool resRank1 = (wc.m_rankAbilityTree->find(AbilityDataTeam(12, 13)));
    bool resRank2 = (wc.m_rankAbilityTree->find(AbilityDataTeam(11, 11)));
